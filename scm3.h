...
int f_gcd(int addr);
int f_lcm(int addr);
int f_floor(int addr);
int f_ceiling(int addr);
int f_truncate(int addr);
int f_round(int addr);
int f_exit(int addr);
...
int f_positivep(int addr);
int f_negativep(int addr);
int f_oddp(int addr);
int f_evenp(int addr);
int f_exactp(int addr);
int f_inexactp(int addr);
int f_gbc(int addr);
int f_eval(int addr);
...
int f_char_eqp(int addr);
int f_char_lessp(int addr);
int f_char_greaterp(int addr);
int f_char_eqlessp(int addr);
int f_char_eqgreaterp(int addr);
int f_char_ci_eqp(int addr);
int f_char_ci_lessp(int addr);
int f_char_ci_greaterp(int addr);
int f_char_ci_eqlessp(int addr);
int f_char_ci_eqgreaterp(int addr);
...
int f_str_eqlessp(int addr);
int f_str_eqgreaterp(int addr);
int f_str_ci_eqp(int addr);
int f_str_ci_lessp(int addr);
int f_str_ci_greaterp(int addr);
int f_str_ci_eqlessp(int addr);
int f_str_ci_eqgreaterp(int addr);
