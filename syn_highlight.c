...
static const char *builtin[] = {
    "-", "*", "/=", "+", "<", "<=", "=", ">", ">=",
    "abs", "append", "apply", "assoc", "atan",
    "atom?", "vector?", "car", "cdr", "char<?", "char<=?", "char=?",
    "char>?", "char>=?", "character?", "cons", "pair?", 
    "cos", "cosh", "eq?", "eqv?", "equal?", "error",
    "eval", "exp", "float?", "gbc", "gcd", "integer?",
    "isqrt", "lcm", "length", "list",
    "list?", "load", "log", "map", "for-each", "max", "member", "min", "mod",
    "not", "null?", "number?", "write", "display", "property", "quit", "quotient", 
    "read-char", "read", "reverse", "round",
    "set-car!", "set-cdr!", "sin", "sinh", "sqrt",
    "string/=?", "string<?", "string<=?", "string=?", "string>?", "string>=?", "string",
    "symbol?", "tan", "tanh", "vector", 
};
